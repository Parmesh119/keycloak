...
//            if (httpRequest.servletPath.startsWith("/api/users/list")) {
//                val token: String = (httpRequest.getHeaders("access_token").toString()
//                        ?: throw RuntimeException("No access token provided")
//                        ).replace("Bearer ", "")
//                println(token)
//                if (token != null) {
...
//                            verifiedJWT.subject,
//                            null,
//                            listOf(SimpleGrantedAuthority("ROLE_ADMIN")) // Or roles from JWT
//                        )
//                        println("in custom authentication")
//                } else {
